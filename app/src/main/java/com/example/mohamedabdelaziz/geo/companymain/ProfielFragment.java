...
public class ProfielFragment extends Fragment {
    ...
    private TextView tvName, tvEmail, fullname;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        fullname = rootView.findViewById(R.id.tvNumber5);
        ...
        fullname.setText(preferences.getString(Constants.FULL_NAME, "not available now"));
        return rootView;
    }
}
