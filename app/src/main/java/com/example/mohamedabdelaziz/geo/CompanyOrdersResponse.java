...
public class CompanyOrdersResponse {
    ...
    private List<CompanyOrdersProduct> products = null;
    ...
    public List<CompanyOrdersProduct> getProducts() {
        return products;
    }

    public void setProducts(List<CompanyOrdersProduct> products) {
        this.products = products;
    }


    public static class CompanyOrdersProduct {
